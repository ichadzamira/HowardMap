...
public class EuclideanGraph {
    ...
    *******************************************************************/
    public EuclideanGraph(In in) {
    	//parses the strings that are read into integers
        ...
        for (int i = 0; i < V; i++) {
            ...
            //If the vertices in the textfile is less that 0;
            //Or greater than the actual vertices used in the file then:
            if (v < 0 || v >= V) throw new RuntimeException("Illegal vertex number");
            //Making an array of off calling the constructor of the class point
